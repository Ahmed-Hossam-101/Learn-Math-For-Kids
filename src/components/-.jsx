...
let random_Number2 =  Math.floor(Math.random() * (Lv *40)) ;
 let result =random_Number - random_Number2 < 0 ?++random_Number :random_Number - random_Number2
...
console.log((+document.querySelector('.inp').value - +random_Number) === result);
    ...
    pop2.classList.add('pop');
      ...
      pop.style.cssText =`position:absolute;width:100px;height:100px;top:${top}%;left:${left}%;text-align:center;z-index:1;`
...
function answer(e) {
  ...
  document.querySelector('.inp').value =  random_Number- result  ; 
}
  return (
    <div id='plus'>
